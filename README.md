# 💲 store77 price checker telegram bot

Телеграм бот для отслеживания изменения цен на определенные товары в магазине [store77](https://store77.net/).
...
2. Выполнить скрипт миграции `migrate.sql` в [YDB UI](http://localhost:8765/)
