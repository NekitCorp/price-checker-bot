...
async function migrate() {
    ...
    await new Price({ productId: '531733', price: 128980, created: today.add(-1, 'd').toDate() }).insert(driver);
    await new Price({ productId: '531733', price: 130980, created: today.add(-2, 'd').toDate() }).insert(driver);
    // 668506
    await new Price({ productId: '668506', price: 105980, created: today.toDate() }).insert(driver);
    await new Price({ productId: '668506', price: 105980, created: today.add(-1, 'd').toDate() }).insert(driver);
    await new Price({ productId: '668506', price: 105980, created: today.add(-2, 'd').toDate() }).insert(driver);
    // 700880
