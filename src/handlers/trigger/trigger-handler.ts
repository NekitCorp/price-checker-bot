...
export async function triggerHandler(bot: ITelegramBot, logger: ILoggerService, dbDriver: IDbDriver) {
 ...
 */
async function updatePrices(logger: ILoggerService, dbDriver: IDbDriver) {
